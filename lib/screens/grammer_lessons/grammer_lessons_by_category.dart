...
class GrammerLessonsByCategory extends StatelessWidget {
  ...
  GrammerLessonsByCategory({Key key, this.name}) : super(key: key);
          ...
          Padding(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                // List of courses
                FutureBuilder(
                  future:httpService.fetchGrammerLessonsByCategory(this.name),
