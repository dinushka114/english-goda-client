...
class GrammerLesson extends StatelessWidget {

  final GrammerLessonsByTitle lesson;

  const GrammerLesson({Key key, this.lesson}) : super(key: key);
            ...
            Padding(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  HtmlWidget(this.lesson.content,
